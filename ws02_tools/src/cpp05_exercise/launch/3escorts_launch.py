...
def generate_launch_description():
    ...
    spwan_left = Node(package="cpp05_exercise", executable="exer01_spawn",
                 name="spawn_left", 
                 parameters=[{"x":3.0, "y":9.0, "turtle_name":LaunchConfiguration("turtle_left")}])
    
    spwan_right = Node(package="cpp05_exercise", executable="exer01_spawn",
                 name="spawn_right", 
    ...
    escort_goal_left = Node(package="tf2_ros", executable="static_transform_publisher", name="escort_goal_left",
                            arguments=["--frame-id", "turtle1", "--child-frame-id", "escort_goal_left", "--x", "-1.5", "--y", "1.5"])
    ...
    escort_goal_right = Node(package="tf2_ros", executable="static_transform_publisher", name="escort_goal_right",
                            arguments=["--frame-id", "turtle1", "--child-frame-id", "escort_goal_right", "--x", "-1.5", "--y", "-1.5"])
    # 4.监听坐标变换
    ...
    return LaunchDescription([escort_back, escort_left, escort_right, 
                              master, 
                              spwan_back, spwan_left, spwan_right,
